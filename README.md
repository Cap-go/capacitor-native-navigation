...
| **`experimentalBakedTintColors`**    | <code>boolean</code>                                                                                      | Opt into the iOS 26 Liquid Glass tint workaround that renders active and inactive tab labels into icon images. This can affect badge positioning and icon sizing, so it is disabled by default. |
